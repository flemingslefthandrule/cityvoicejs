...
const LeftHome = (props) => {
    ...
    return (
        <div className="w-[20%] h-[100%] flex flex-col p-2 items-center space-y-2">
            <p className="font-bold text-4xl">City Voice</p>
            { myUserName && 
            <><div onClick={()=>{navigate('/profile/'+myUserName)}} className="items-center justify-center w-full flex gap-3 items-center p-2 bg-gray-700 hover:bg-gray-600 rounded-md cursor-pointer">
