...
const Login = () => {
  ...
  return (
    <div className="bg-gray-900 w-screen h-screen">
      <div className="flex justify-center items-center text-slate-100 p-[100px]">
        <div className="  border-white shadow-lg bg-[#F9DBBD] bg-opacity-10 min-w-[400px]  rounded p-4">
          ...
          <form className="flex flex-col items-center" onSubmit={handleSubmit}>
            ...
            <div className="pt-2 w-11/12 relative">
              <div className="w-fit inline-block">
                <input className="" type="checkbox" required /> remember me
              </div>
